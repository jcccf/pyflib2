...
for year in range(START_YEAR+1,START_YEAR+1+T):
  ...
  plot_frequency_distribution_array(path+"degree_distribution_%d" % year, [nx.degree(G),base_data['degrees'][year]], ylabel='Number of Authors', xlabel='Degree', labels=default_labels)
