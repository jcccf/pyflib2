...
def doComparison(START_YEAR=1997,T=5,P=0.4,Q=0.4,PREFIX="p",year=2002):
  ...
  G2 = nx.read_edgelist("../data/parsed/authorship_2002.edgelist", comments='#', delimiter='|', data=True, encoding='utf-8')
  ...
  activities2 = defaultdict(int)
  for _,years in authors.iteritems():
    if len(years) < 50:
      activities2[len(years)] += 1
  plot_xy_array(path+"activity_distribution_log", [activities,activities2], labels=['Predicted','Actual'], ylabel='Number of Authors', xlabel='Number of Collaborations', log=True, linetype='o')
  # plt.clf()
...
doComparison(START_YEAR=1997,T=5,P=0.4,Q=0.4,PREFIX="",year=2002)
doComparison(START_YEAR=1997,T=5,P=0.4,Q=0.4,PREFIX="p",year=2002)
doComparison(START_YEAR=1997,T=5,P=0.4,Q=0.4,PREFIX="p38k2",year=2002)
doComparison(START_YEAR=1997,T=5,P=0.4,Q=0.4,PREFIX="ca",year=2002)
doComparison(START_YEAR=1997,T=5,P=0.4,Q=0.4,PREFIX="cb",year=2002)
doComparison(START_YEAR=1997,T=5,P=0.4,Q=0.4,PREFIX="cc",year=2002)
doComparison(START_YEAR=1997,T=5,P=0.4,Q=0.4,PREFIX="cd",year=2002)
doComparison(START_YEAR=1997,T=5,P=0.0,Q=0.0,PREFIX="base",year=2002)
doComparison(START_YEAR=1997,T=5,P=0.0,Q=0.0,PREFIX="base2",year=2002)
doComparison(START_YEAR=1997,T=5,P=0.0,Q=0.0,PREFIX="base2b",year=2002)