...
plot_xy_array(path+"activity_distribution_log", [activities,activities2], labels=['Predicted','Actual'], ylabel='Number of Authors', xlabel='Number of Collaborations', log=True)
# plt.clf()
